...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SizUtil",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7SizUtil15FloatRatingView")
...
SWIFT_PROTOCOL("_TtP7SizUtil23FloatRatingViewDelegate_")
@protocol FloatRatingViewDelegate
@optional
...
SWIFT_CLASS("_TtC7SizUtil16SizCellForButton")
@interface SizCellForButton : SizPropertyTableCell
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7SizUtil18SizCellForDateTime")
@interface SizCellForDateTime : SizPropertyTableCell
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7SizUtil18SizCellForEditText")
@interface SizCellForEditText : SizPropertyTableCell <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC7SizUtil19SizCellForMultiLine")
@interface SizCellForMultiLine : SizPropertyTableCell
...
SWIFT_CLASS("_TtC7SizUtil15SizCellForOnOff")
@interface SizCellForOnOff : SizPropertyTableCell
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7SizUtil16SizCellForRating")
@interface SizCellForRating : SizPropertyTableCell <FloatRatingViewDelegate>
/// Returns the rating value when touch events end
- (void)floatRatingView:(FloatRatingView * _Nonnull)ratingView didUpdate:(double)rating;
/// Returns the rating value as the user pans
- (void)floatRatingView:(FloatRatingView * _Nonnull)ratingView isUpdating:(double)rating;
...
SWIFT_CLASS("_TtC7SizUtil17SizCellForStepper")
@interface SizCellForStepper : SizCellForEditText
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7SizUtil14SizCellForText")
@interface SizCellForText : SizPropertyTableCell
@property (nonatomic, readonly, strong) UILabel * _Nullable detailTextLabel;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7SizUtil22SizPopupPickerViewBase")
@interface SizPopupPickerViewBase : UIView
...
SWIFT_CLASS("_TtC7SizUtil18SizPopupPickerView")
@interface SizPopupPickerView : SizPopupPickerViewBase
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_PROTOCOL("_TtP7SizUtil26SizPopupPickerViewDelegate_")
@protocol SizPopupPickerViewDelegate <UIPickerViewDelegate>
@optional
- (void)pickerViewWithPickerView:(UIPickerView * _Nonnull)pickerView didSelect:(NSArray<NSNumber *> * _Nonnull)numbers;
@end



SWIFT_CLASS("_TtC7SizUtil20SizPropertyTableView")
@interface SizPropertyTableView : UITableView <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC7SizUtil12SizTableView")
@interface SizTableView : UITableView <UITableViewDelegate>
- (nonnull instancetype)initWithFrame:(CGRect)frame style:(UITableViewStyle)style OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
@interface UIViewController (SWIFT_EXTENSION(SizUtil))
